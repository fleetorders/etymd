...
- e199ccc: `fleet add --profile guarded` now records the alias-to-directory mapping too, not just the entry.
...
- 52ebca8: Fix: `fleet add --profile guarded` was silently ignored, registering guarded-side repos as personal.
